			...
			if (s != "") {
				...
				if (event == "telemetry") {
					...
					*/
					...
					// the vehicle is the center of the system. So, waypoints need to be trasformed to the car coordinates, where the center of the vehicle is (0,0)
					...
					// Solve to predict x and y in the future
					auto output = mpc.Solve(pred_state, coeffs);
					...
					vector<double> mpc_x_vals = { pred_state[0] };
					vector<double> mpc_y_vals = { pred_state[1] };
